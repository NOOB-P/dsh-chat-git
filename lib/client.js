    ...
    function HistoryView(props) {
      ...
      const commitRow = (commit) => {
        ...
        return h('div', { key: commit.sha, className: 'dsh-chat-git-commit' },
          h('div', { style: panelStyles.cardHead },
            h('span', { style: panelStyles.cardTurn }, commit.short),
            h('span', { style: panelStyles.cardTime }, clockOf(Date.parse(commit.date))),
          ),
      ...
      const conversationPane = h('div', { style: panelStyles.pane },
      ...
      const repoPane = h('div', { style: panelStyles.pane },
        h('div', { style: panelStyles.header },
        ...
        repoError !== '' ? h('span', { style: { ...panelStyles.muted, color: PANEL.danger } }, repoError) : null,
        ...
        const sync = () => {
          if (historyState.enabled && dispose === null) {
            dispose = ctx.slots.register({
              ...
              order: 20,
              label: '历史',
            }, (props) => h(HistoryView, { ...props, branch }))
